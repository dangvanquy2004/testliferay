...
import com.test.database.NoSuchDepartmentException;
import com.test.database.model.Department;
import com.test.database.model.impl.DepartmentImpl;
import com.test.database.model.impl.DepartmentModelImpl;
...
public class DepartmentPersistenceImpl extends BasePersistenceImpl<Department>
	 ...
	 */
	public Department create(int iddepartment) {
		Department department = new DepartmentImpl();

		department.setNew(true);
		department.setPrimaryKey(iddepartment);
	 ...
	 */
	public Department remove(int iddepartment)
		throws NoSuchDepartmentException, SystemException {
		return remove(Integer.valueOf(iddepartment));
	}
	...
	protected Department toUnwrappedModel(Department department) {
		...
		departmentImpl.setIddepartment(department.getIddepartment());
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Department findByPrimaryKey(int iddepartment)
		throws NoSuchDepartmentException, SystemException {
		Department department = fetchByPrimaryKey(iddepartment);

		if (department == null) {
			if (_log.isWarnEnabled()) {
				_log.warn(_NO_SUCH_ENTITY_WITH_PRIMARY_KEY + iddepartment);
			}
		...
		if (department == null) {
			...
			try {
				...
				if (department != null) {
					...
					EntityCacheUtil.putResult(DepartmentModelImpl.ENTITY_CACHE_ENABLED,
						DepartmentImpl.class, iddepartment, _nullDepartment);
				}
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.test.database.model.Department")));
