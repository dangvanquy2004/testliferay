...
import com.test.database.model.DepartmentClp;
import com.test.database.model.EmployeeClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"testliferay1-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "testliferay1-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"com.test.database.model.impl.DepartmentImpl")) {
			return translateOutputDepartment(oldModel);
		}

		if (oldModelClassName.equals(
					"com.test.database.model.impl.EmployeeImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals("com.test.database.NoSuchDepartmentException")) {
			return new com.test.database.NoSuchDepartmentException();
		}

		if (className.equals("com.test.database.NoSuchEmployeeException")) {
			return new com.test.database.NoSuchEmployeeException();
		}
