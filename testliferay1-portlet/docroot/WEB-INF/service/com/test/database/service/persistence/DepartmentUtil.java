...
public class DepartmentUtil {
	...
	*/
	public static void cacheResult(
		java.util.List<com.test.database.model.Department> departments) {
	...
	*/
	public static com.test.database.model.Department create(int iddepartment) {
		return getPersistence().create(iddepartment);
	}
	...
	* @throws com.test.database.NoSuchDepartmentException if a department with the primary key could not be found
	* @throws SystemException if a system exception occurred
	*/
	public static com.test.database.model.Department remove(int iddepartment)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.test.database.NoSuchDepartmentException {
		return getPersistence().remove(iddepartment);
	}

	public static com.test.database.model.Department updateImpl(
	...
	/**
	* Returns the department with the primary key or throws a {@link com.test.database.NoSuchDepartmentException} if it could not be found.
	*
	* @param iddepartment the primary key of the department
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.test.database.model.Department findByPrimaryKey(
		int iddepartment)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.test.database.NoSuchDepartmentException {
		return getPersistence().findByPrimaryKey(iddepartment);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.test.database.model.Department fetchByPrimaryKey(
		int iddepartment)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(iddepartment);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.test.database.model.Department> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static DepartmentPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (DepartmentPersistence)PortletBeanLocatorUtil.locate(com.test.database.service.ClpSerializer.getServletContextName(),
